...
gitGraph
    commit id: "feat: 初期コミット - README追加" tag: "be4c560"
    ...
    commit id: "feat: 機能1のファイルを追加" tag: "e087543"
    commit id: "feat: 機能2のファイルを追加" tag: "949a644"
    commit id: "fix: 機能3のバグ修正" tag: "0175c74"

    checkout dev
    merge feature/test-flow tag: "PR #1 Squash" id: "feat: テスト機能の追加 (#1)" type: HIGHLIGHT

    checkout main
    merge feature/test-flow tag: "PR #2 Squash" id: "feat: テスト機能の追加 (main用) (#2)" type: HIGHLIGHT
```

### フローの説明

1. **初期状態**: `main`ブランチに初期コミット
